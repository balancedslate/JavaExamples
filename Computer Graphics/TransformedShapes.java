...
public class TransformedShapes extends JPanel {
	...
	// TODO Draw the required image, using ONLY the four methods defined
	// above, along with g2.setColor, g1.scale, g2.translate, and g2.rotate

	/* ------------------------------------------------------------------ */
	
	// REMOVE THE FOLLOWING CODE, which draws a big red X in the
	// upper right quadrant, and insert your own code to draw the
	// required pictures in the four quadrants.
